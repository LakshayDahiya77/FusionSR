...
CONFIG = {
    ...
    "unified_hr_dir": "/dev/shm/UnifiedHR",
    "unified_filters": {"lsdir": 5000},
    "preload_to_ram": False,
    "train_hr_dirs": [],
    "train_lr_dirs": [],
    "val_hr_dir": "/dev/shm/Validation-Datasets/Urban100/GTmod12",
    "val_lr_dir": "/dev/shm/Validation-Datasets/Urban100/LRbicx4",
    "wandb_entity": "lakshay_dahiya77",
    "wandb_project": "FusionSR-v4",
    "wandb_run": "v4-kaggle-t4x2",
    "wandb_run_id": None,
    "resume": "lakshay_dahiya77/FusionSR-v4/fusionsr-best:v79",
...
def main():
    ...
    assert config["val_hr_dir"]
    assert config["val_lr_dir"]
    ...
    if torch.cuda.device_count() > 1:
        print(f"Distributing batch across {torch.cuda.device_count()} GPUs")
